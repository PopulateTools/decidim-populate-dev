...
Decidim.configure do |config|
  ...
  config.application_name = "Forum Greenpeace"

  # The email that will be used as sender in all emails from Decidim
  config.mailer_sender = Rails.env.staging? ? "no-reply@decidim-review-apps.populate.tools" : "no-reply@forum.greenpeace.es"
  ...
  config.force_ssl = Rails.env.staging? || Rails.env.production?
